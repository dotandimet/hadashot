Ext.define('FeedViewer.FeedGrid', {
    ...
    onLoad: function(store, records, success) {
        if (this.getStore().getCount()) {
            ...
            var first_rec_dir = this.getStore().getAt(0).get('title_dir');
            var cur_dir = this.view.rtl;
            this.view.rtl = ( first_rec_dir === 'rtl' ) ? true : false;
            if (cur_dir != this.view.rtl) {
    ...
    loadFeed: function(url){
        ...
        store.getProxy().extraParams.src = url;
        store.load();
    },
